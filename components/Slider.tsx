...
const Slider = ({images}:{images:string[]}) => {
  ...
  return (
    <div className='max-w-[1400px] h-[640px] w-full m-auto py-16 relative group'>
      <Image src={images[index]} height={480} width={640} alt='Picture of a product' className='w-full h-full rounded-2xl bg-center bg-cover duration-500'/>
