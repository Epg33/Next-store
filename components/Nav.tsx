...
const Nav: React.FC<NavBar> = ({ inView, setShowNav }): JSX.Element | null => {
  ...
  return (
    <>
      <div className="w-full h-screen fixed flex z-20 flex-col justify-start items-end backdrop-blur-sm inset-0 pr-4 pt-4" onClick={()=>setShowNav(false)}>
        <nav className="z-[100] bg-slate-700 h-3/5 w-5/6 flex flex-col items-start gap-5 pt-4 pl-4 rounded-xl sm:w-3/5 md:w-2/4 lg:w-1/4">
